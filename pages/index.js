    ...
    >
      <Container className="mt-2 min-vh-100">
        ...
        <Row className="rounded shadow-sm mb-3 p-5 bg-white">
          <Col>
            <p>
              ...
              with woven tops and slowly developed new lines like knitwear,
              woven bottoms and our latest addition DMC Apparels Limited, a
              vertically integrated 8 storied building with three floors
              equipped with modern heavy sewing machines accompanying with an
              innovative, advanced and eco-friendly Laundry with the core motive
              of manufacturing Denim wears mainly.
            </p>
            <p>
              Arunima Group has worked with several renowned brands such as
              Wrangler, Lee, Nautica, North Face, Timberland, Target, Walmart,
              GAP, George&apos;s, Bass Pro, Matalan, Pepco, Primark, Terranova
              and so no. With full technical support from VF (now Kontoor)
              engineers, Arunima Group has reached its current potential and is
              growing at a significant pace. Arunima Group has exciting plans
              for the future with various upcoming projects and is developing
              its current ones to reach its full potential.
            </p>
          </Col>
          {/* <Col>
          <Image
        ...
        <Row className="rounded shadow-sm mb-3 p-5 bg-white">
          <Col>
            <p>
              At Arunima, our mission is to persevere for perfection in
              everything we do, whether it is development, final assembly, or
              delivery, to ensure that our customers have best possible
              experience working with us.
              <br /> We are an Apparel development and manufacturing company
              committed to skilled craftmanship, compliance, and timeliness
              while always aspiring for Excellence.
            </p>
          </Col>
        </Row>
