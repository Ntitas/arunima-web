    ...
    <Container className="mt-3 min-vh-100">
      ...
      <Row className="rounded shadow bg-light">
        <Col sm={8} className="p-5">
          ...
          <p>
            <strong>Day care facility:</strong> We have day care facility along
            with food during factory schedule.
          </p>
          <p>
            <strong>Transport:</strong> We provide free of cost transport among
            the employees.
          </p>
          <p>
          ...
          <p>
            <strong>Festival Bonus:</strong> 02 festival bonuses are applicable
            for one year old employees.
          </p>
          <p>
